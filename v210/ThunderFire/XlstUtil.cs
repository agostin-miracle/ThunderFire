...
namespace ThunderFire
{
    ...
    public partial class XsltUtil
    {
        ...
        /// <summary>
        /// Formata um campo de acordo com as definições de <veja cref="MazeFire.MaskText"/>
        /// </summary>
        ...
        {
            return Constants.UnShuffle(text);
            //string retorno = "";
            //for (int i = 0; i < text.Length; i++)
            //{
            //    char c = Convert.ToChar(text.Substring(i, 1));
