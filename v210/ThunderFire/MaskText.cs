...
namespace ThunderFire
{
    ...
    public static class MaskText
    {
        ...
        /// </summary>
        public static string DefaultCultureOut = "pt-br";
        /// <summary>
            ...
            else if (format == "EXTENSO.VALOR")
            {
                if (text.CompareTo("") != 0)
                {
                    if (Decimal.TryParse(text, out decimal _out))
                        return ValueExtensive.Get(_out);
                    else
        ...
        /// <summary>
        /// Método Padrão de Formatação de Células para uma GridView
        /////// </summary>
        /////// <param name="format">Especificação do Formato</param>
        /////// <param name="formatting">DataGridViewCellFormattingEventArgs</param>
        ////public static void GridCellFormat(string format, DataGridViewCellFormattingEventArgs formatting)
        ////{
        ////    if (formatting.Value != null)
        ////    {
        ////        try
        ////        {
        ////            string s = formatting.Value.ToString();
        ////            formatting.Value = MaskText.Mask(format, s.ToString());
        ...
        /// </summary>
        /// <param name="formatting">DataGridViewCellFormattingEventArgs</param>
        /////// <param name="FreeFormat">String de Formatação Livre</param>
        ////public static void GridCellFormat(DataGridViewCellFormattingEventArgs formatting, string FreeFormat)
        ////{
        ////    if (formatting.Value != null)
        ////    {
        ////        try
        ////        {
        ////            formatting.Value = String.Format(FreeFormat, formatting.Value.ToString());
        ////            formatting.FormattingApplied = true;
        ////        }
        ////        catch (Exception)
        ////        {
    ...
    public class CustomFormat : IFormatProvider, ICustomFormatter
    {
        ...
        public string Format(string format, object arg, IFormatProvider formatProvider)
        {
            ...
            return MaskText.Mask(format, text);
        }
    }
}
