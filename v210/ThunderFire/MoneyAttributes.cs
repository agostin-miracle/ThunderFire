namespace ThunderFire
{
    ...
    public class MoneyAttributes
    {
        ...
        /// Construtor
        /// </summary>
        public MoneyAttributes(MoneySettings _ms)
        {
            this.CurrenctSymbol = _ms.CurrentSymbol;
            this.SingleMonetaryUnit = _ms.SingleMonetaryUnit;
            this.PluralMonetaryUnit = _ms.PluralMonetaryUnit;
            this.AddCurrencySymbol = _ms.AddCurrencySymbol;
            this.MessageValueNotSupplied = _ms.MessageValueNotSupplied;
            this.MessageValueNotSupported = _ms.MessageValueNotSupported;
            this.Mile = _ms.Mile;
            this.Hundred = _ms.Hundred;
        }
    ...
    {
        public string CurrentSymbol { get; set; } = "R$";
        public string SingleMonetaryUnit { get; set; } = "Real";
       public string PluralMonetaryUnit { get; set; } = "Reais";
        public bool AddCurrencySymbol { get; set; } = false;
        public string MessageValueNotSupplied { get; set; } = "Valor não informado";
        public string MessageValueNotSupported { get; set; } = "Valor não suportado";
        public string Mile { get; set; } = "Mil";
        public string Hundred { get; set; } = "Cento";
    }
}
