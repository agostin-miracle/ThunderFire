...
namespace ThunderFire
{
    ...
    public class Validator
    {
        ...
        /// <summary>
        /// Expressão Regular para validação do Prazo de Validade de um cartão
        /// </summary>
        ...
        /// <summary>
        /// Expressão Regular para Telefone Ativacao
        /// </summary>
        public static string VALIDATEACTIVATIONPHONE = @"[0-9]{2}[0-9]{2}[0-9]{8}";
        /// <summary>
        /// Expressão Regular para Celular Ativação
        /// </summary>
        ...
        /// <returns>true, se o cartão é valido</returns>
