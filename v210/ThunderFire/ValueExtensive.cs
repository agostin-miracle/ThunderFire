...
namespace ThunderFire
{
    ...
    public class ValueExtensive
    {
        ...
        public static string Get(decimal pValor, MoneySettings _ms=null)
        {
            if (_ms == null)
                _ms = new MoneySettings();
            MoneyAttributes objeto = new MoneyAttributes(_ms);
            string strValorExtenso = ""; 
